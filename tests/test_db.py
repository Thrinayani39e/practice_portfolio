...
class TestTimelinePost(unittest.TestCase):
    ...
    def test_timeline_post(self):
        ...
        assert posts_by_name['John Doe'].content == 'Hello world, I\'m John!'
        assert posts_by_name['Jane Doe'].email == 'jame@example.com'
        assert posts_by_name['Jane Doe'].content == 'Hello world, I\'m Jane!'
